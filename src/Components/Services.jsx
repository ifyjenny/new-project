  ...
  const cardsData = [
    {
      ...
      title: "Air Freight",
      content:
        "As a leader in global air freight forwarding, OIA Global excels in providing tailored ...",
    },
    {
      image: pic2,
      title: "Sea Freight",
    ...
    },
    {
      ...
      title: "Warehousing",
      content:
        "Package and store your things effectively and securely to make sure them in...",
    },
    {
      image: pic5,
      title: "Door to Door Delivery",
      content:
        "Our expertise in transport management and planning allows us to design ...",
    },
    {
      image: pic6,
      title: "Packaging & Storage",
      content:
        "Package and store your things effectively and securely to make sure them ...",
    },
    ...
    <>
      <div className="cover">
        <div className="text-center pt-3 text-light">
          ...
          <p>
            Home <i className="fa fa-arrow-right ms-3 me-3"></i> Service
          </p>
        </div>
      </div>
          ...
          <div className="col-md-5" data-aos="fade-up">
            ...
            <div className="pt-5">
              <p>
                ...
                reasonable prices. Pleasure and praising pain was born and I
                will give you a complete account of system, and expound actual
                teachings occasionally circumstances.
              </p>
            </div>
          </div>
        </div>
